...
const FileUpload: React.FC<{ guildId: string }> = ({ guildId }) => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:3001/api/guilds/${guildId}/upload-image`, formData, {
                headers: {
    ...
    return (
      ...
      {image && <button onClick={handleUpload} disabled={uploading}>Upload</button>}
